...
public class UserController {
    ...
    public ResponseEntity<ApiResponse<User>> updateProfile(
            @io.swagger.v3.oas.annotations.Parameter(content = @io.swagger.v3.oas.annotations.media.Content(mediaType = "application/json")) @Valid @org.springframework.web.bind.annotation.RequestPart("request") UpdateProfileRequest request,
